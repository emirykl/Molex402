      ...
      <div className="stripes sticky top-0 flex h-screen flex-col overflow-hidden">
        ...
        <div className="relative z-30 flex flex-wrap items-start justify-between gap-3 p-4 sm:p-6">
          ...
          <a
            ...
            className="box shove grid h-12 w-12 place-items-center rounded-full bg-white hover:bg-acid sm:h-14 sm:w-14"
          >
            <svg viewBox="0 0 16 16" aria-hidden="true" className="h-6 w-6 sm:h-7 sm:w-7" fill="currentColor">
